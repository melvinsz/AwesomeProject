...
const TrashIcon = (props) => (
  <Svg width={70} height={40} fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
    <G clipPath="url(#a)">
      <Rect width={70} height={40} rx={20} fill="#F6F6F6" />
      <Path d="M26 14h18" stroke="#BDBDBD" strokeLinecap="round" strokeLinejoin="round" />
      <Path
        ...
        fill="#BDBDBD"
      />
      <Path d="M33 19v6M37 19v6" stroke="#BDBDBD" strokeLinecap="round" strokeLinejoin="round" />
    </G>
    <Defs>
      <ClipPath id="a">
